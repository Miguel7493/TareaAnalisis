...
import { validarDatosRegistro } from '../utils/validators.js';
...
export class AuthService {
    ...
    async register(userData) {
        const { email, password, nombre, apellido, rut, telefono, direccion } = userData;
        ...
        const rutExists = await clienteRepository.rutExists(rut);
        if (rutExists) {
            throw {
                status: 409,

...
const App = () => {
    ...
    return (_jsxs("div", { className: "relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-100 via-white to-slate-200", children: [_jsxs("div", { className: "pointer-events-none absolute inset-0 mix-blend-multiply", children: [_jsx("div", { className: "aurora-gradient absolute -left-32 top-20 h-72 w-72 rounded-full blur-3xl opacity-40" }), _jsx("div", { className: "aurora-gradient absolute bottom-10 right-0 h-80 w-80 rounded-full blur-3xl opacity-30" })] }), _jsxs("header", { className: "mx-auto flex w-full max-w-6xl items-center justify-between px-6 pt-10", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: "flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-900 text-lg font-semibold text-white", children: "AP" }), _jsxs("div", { children: [_jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.4em] text-slate-500", children: "Aurora Priv\u00E9" }), _jsx("p", { className: "text-sm text-slate-500", children: "Cr\u00E9ditos personalizados para Chile" })] })] }), _jsx("button", { type: "button", onClick: () => {
                            resetState();
                            setActiveMode("login");
                        }, className: "hidden rounded-full border border-slate-300/70 px-5 py-2 text-sm font-medium text-slate-600 transition hover:border-slate-400 hover:text-slate-900 md:inline-flex", children: "Ingresar" })] }), _jsxs("main", { className: "mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center px-6 pb-24 pt-16", children: [_jsxs("section", { className: "mx-auto max-w-3xl text-center", children: [_jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.5em] text-slate-400", children: "Bienvenido" }), _jsx("h1", { className: "mt-6 text-4xl font-semibold text-slate-900 sm:text-5xl", children: "Una banca privada que comienza con una experiencia impecable" }), _jsx("p", { className: "mx-auto mt-5 max-w-2xl text-sm text-slate-500 sm:text-base", children: "Accede a un proceso de registro y autenticaci\u00F3n dise\u00F1ado para proteger tus datos y conectarte con especialistas de confianza." }), _jsxs("div", { className: "mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row", children: [_jsx("button", { type: "button", onClick: () => {
                                            resetState();
                                            setActiveMode("signup");
                                        }, className: "inline-flex w-full items-center justify-center rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition hover:bg-slate-700 sm:w-auto", children: "Crear cuenta" }), _jsx("button", { type: "button", onClick: () => {
                                            resetState();
                                            setActiveMode("login");
                                        }, className: "inline-flex w-full items-center justify-center rounded-full border border-slate-300/70 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:text-slate-900 sm:w-auto", children: "Ingresar" }), _jsx("a", { href: "#simulacion", className: "inline-flex w-full items-center justify-center rounded-full border border-transparent bg-white/70 px-6 py-3 text-sm font-semibold text-slate-700 shadow-inner shadow-white/80 transition hover:border-slate-300 hover:bg-white sm:w-auto", children: "Simula tu cr\u00E9dito" })] })] }), _jsx("section", { className: "mt-16 grid w-full max-w-3xl gap-4 sm:grid-cols-3", "aria-label": "Pilares de confianza", children: [
                            "Identidad verificada",
                            "Custodia cifrada",
                            "Asesoría humana",
                        ].map((item) => (_jsx("div", { className: "rounded-3xl border border-white/60 bg-white/70 px-5 py-6 text-center text-sm font-medium text-slate-600 shadow-sm shadow-slate-900/5", children: item }, item))) }), _jsxs("section", { id: "simulacion", className: "mt-20 w-full max-w-3xl rounded-[2rem] border border-white/60 bg-white/80 p-8 text-left shadow-sm shadow-slate-900/10", children: [_jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.4em] text-slate-400", children: "Simula tu cr\u00E9dito" }), _jsx("h2", { className: "mt-2 text-2xl font-semibold text-slate-900", children: "Conoce tus condiciones en minutos" }), _jsx("p", { className: "mt-3 text-sm text-slate-500", children: "Pr\u00F3ximamente podr\u00E1s estimar cuotas, tasas y beneficios exclusivos sin salir de esta experiencia." }), _jsxs("div", { className: "mt-6 flex flex-wrap items-center gap-3", children: [_jsx("button", { type: "button", onClick: () => showToast("El simulador premium estará disponible pronto.", "info"), className: "inline-flex items-center justify-center rounded-full border border-slate-300/70 px-5 py-2 text-sm font-medium text-slate-700 transition hover:border-slate-400 hover:text-slate-900", children: "Notificarme" }), _jsx("span", { className: "text-xs text-slate-400", children: "Desarrollado para el mercado chileno" })] })] })] }), _jsx("footer", { className: "mx-auto w-full max-w-6xl px-6 pb-12 text-left", children: _jsxs("p", { className: "text-xs text-slate-400", children: ["\u00A9 ", new Date().getFullYear(), " Aurora Priv\u00E9. Todos los derechos reservados."] }) }), toast ? (_jsx("div", { className: "fixed bottom-6 right-6 z-50", children: _jsx("div", { className: `rounded-2xl border px-5 py-3 text-sm font-medium shadow-lg ${toast.tone === "success"
